...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  % Removed redefinitions of \cleardoublepage/\clearpage to avoid breaking
  % vertical mode expectations of titlesec for subsequent \chapter commands.
  % If you need to customize page breaks later, consider lighter tweaks like
  % \let\cleardoublepage\clearpage or the 'openany' class option already in use.
